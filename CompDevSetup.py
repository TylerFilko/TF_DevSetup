...
def mac_dev_setup():
    ...
    subprocess.check_call(['ln', '-s', '$HOME/DevelopmentSetup/pythonrc.py', '/Users/tafilko/pythonrc.py'])
    subprocess.check_call(['ln', '-s', '$HOME/DevelopmentSetup/inputrc', '/etc/.inputrc'])
